...
import 'clsx';
import { $ as $$Copyright, a as $$Navigator, b as $$Header, e as escapePercent, j as json } from './chunk.c5d805a1.js';
/* empty css                *//* empty css                */
...
const $$Ale = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "ALE CYCLING | MIS Sport \u7C73\u8A69\u570B\u969B", "darkText": true }, { "default": ($$result2) => renderTemplate(_a || (_a = __template(["   ", '<section id="aleBanner2"> <div class="inner"> <h1>ALE WINTER<br></h1> <h6> <br>\u7121\u61FC\u5BD2\u51B7\u7684\u6EAB\u5EA6\u3001\u98A8\u4EE5\u53CA\u96E8\u3002\n<br>\u7121\u8AD6\u5728\u4F55\u7A2E\u689D\u4EF6\u4E0B\u9A0E\u4E58\uFF0CAl\xE9 \u59CB\u7D42\u6703\u8B93\u60A8\u611F\u5230\u4FDD\u8B77\u3001\u6EAB\u6696\u3001\u900F\u6C23\uFF0C\u8B93\u60A8\u7684\u904B\u52D5\u8868\u73FE\u80FD\u5920\u767C\u63EE\u5230\u6975\u81F4\u3002\n</h6> </div> </section> ', '  <script defer src="/assets/js/ale-banner-2.js"><\/script> <script defer src="/assets/js/jquery.selectorr.min.js"><\/script>  '])), maybeRenderHead(), renderComponent($$result2, "ProductList", $$ProductList, { "id": "aleWinter", "brandName": BRAND_NAME, "products": productlistByTopic[0] })) })}`;
